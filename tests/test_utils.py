...
dict1 = {'id': 285353808, 'state': 'EXECUTED', 'date': '2017-08-06T16:22:54.643491',
         'operationAmount': {'amount': '82946.19', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Открытие вклада', 'to': 'Счет 12189246980267075758'}
dict2 = {'id': 879660146, 'state': 'EXECUTED', 'date': '2018-07-22T07:42:32.953324',
...
dict3 = {'id': 200634844, 'state': 'CANCELED', 'date': '2019-02-13T04:43:11.374324',
...
dict4 = {'id': 407169720, 'state': 'EXECUTED', 'date': '2020-02-03T14:52:08.093722',
...
def test_get_date():
    ...
    assert get_date(dict3) == '2019-02-13T04:43:11.374324'


def test_get_description():
    assert get_description(dict1) == 'Открытие вклада'
    assert get_description(dict4) == 'Перевод с карты на карту'


def test_get_full_card_data():
    assert get_full_card_data(dict1) == ''
    assert get_full_card_data(dict2) == 'Счет 19628854383215954147'


def test_get_full_account_data():
    assert get_full_account_data(dict3) == 'Счет 45735917297559088682'
    assert get_full_account_data(dict4) == 'Maestro 3806652527413662'
...
def test_get_currency_name():
    ...
    assert get_currency_name(dict4) == 'руб.'
